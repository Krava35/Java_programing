...
public class Route implements Serializable {
     ...
     */
    public Route(int id, String name, Coordinates coordinates, LocalDateTime creationDate, LocationFrom from, LocationTo to, Long distance, User owner) {
        super();
        this.id = id;
        this.name = name;
    ...
    @Override
    public int hashCode() {
        return Objects.hash(id, name, coordinates, creationDate, locationFrom, locationTo, distance, owner);
    }
